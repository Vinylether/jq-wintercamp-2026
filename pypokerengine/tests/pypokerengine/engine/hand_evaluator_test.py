...
class HandEvaluatorTest(BaseUnitTest):
  ...
  def test_straight_with_ace_to_five(self):
    community = [
        Card(Card.CLUB, 2),
        Card(Card.CLUB, 3),
        Card(Card.DIAMOND, 4),
    ...
    self.eq(HandEvaluator.STRAIGHT, HandEvaluator._HandEvaluator__mask_hand_strength(bit))
    self.eq(5, HandEvaluator._HandEvaluator__mask_hand_high_rank(bit))  # 5作为最高牌
    self.eq(0, HandEvaluator._HandEvaluator__mask_hand_low_rank(bit))
    self.eq(14, HandEvaluator._HandEvaluator__mask_hole_high_rank(bit))
    self.eq(8, HandEvaluator._HandEvaluator__mask_hole_low_rank(bit))
   
  def test_straight_with_ace_to_five_minimal(self):
    community = [
        Card(Card.CLUB, 2),
        Card(Card.CLUB, 3),
        Card(Card.DIAMOND, 4),
    ...
    self.eq(0, HandEvaluator._HandEvaluator__mask_hand_low_rank(bit))
    self.eq(14, HandEvaluator._HandEvaluator__mask_hole_high_rank(bit))
    self.eq(5, HandEvaluator._HandEvaluator__mask_hole_low_rank(bit))
